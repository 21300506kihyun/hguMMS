 ...
 <head>
   ...
   <style type="text/css">
     ...
     .bbs_table th{padding:10px 9px 7px;border-width:0 0 0 1px;border-color:#dcdee2;border-style:solid;text-align:center;background-color:/*#eff0f2*/#d5d5d5;color:#333}
     ...
     .schu_line_bg{border:1px solid #ccc !important; background-color:/*#f9fafa*/ /*Gainsboro; */silver;}
     .schu_yes_bg{border:1px solid #ccc !important; cursor:pointer}
   ...
   <?php
     ...
     $sql = "SELECT * FROM user_info WHERE email='$prof_email'";
     ...
     echo $data['office'];
     echo $img;
     $prof_department = $data['department'];
     $prof_img = $img;
     $prof_office = $data['office'];
     $prof_phone = $data['phone'];
 ...
 <body>
   ...
   <div class="row">
     ...
     <div class="column middle">
       ...
       <h3 class="sub_subtitle">면담 제공자 정보</h3>
       <div class="prof_info">
         <h1 class="prof_icon"> <img src="<?php echo $prof_img?>"></i></h1>
         <div class="prof_content_1">
           <h3 class="content_info1">이름 : <?php echo $prof_name?></h3>
           <h3 class="content_info1">소속 학부 : <?php echo $prof_department?></h3>
         </div>
         <div class="prof_content_2">
           <h3 class="content_info2">오피스 : <?php echo $prof_office?></h3>
           <h3 class="content_info2">E-mail : <?php echo $prof_email?></h3>
           <h3 class="content_info2">Phone : <?php echo $prof_phone?></h3>
         </div>
       </div>
             ...
             for($t =0; $t < 24; $t++){ // 몇개의 시간단위로 쪼갤 것인지 // 각 요일에 맞게 시간 table 만들기
               ...
               for($i = 0; $i < $count; $i++){ //
                 ...
                 $col = 0;
                   ...
                   if($col == 0){
                     echo "<td id =". $var_dt . " class='schu_line_bg'>" .
                     "<div class='schedule_area_v1'>" . "<span class='schedule_close'>X</span>" . "\n" ."</div>".$todo. "</td>";}
                   else {
                     echo "<td id =". $var_dt . " style ='background-color:white;' class='schu_yes_bg yes_hover' onClick='javascript:clickTdEvent(this)'>" .
